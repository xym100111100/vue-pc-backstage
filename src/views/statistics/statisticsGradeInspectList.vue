<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="createBy" label="扦祥仓房(活拉)号"> </el-table-column>
      ...
      <el-table-column prop="createBy" label="入库年限"> </el-table-column>
      <el-table-column prop="createBy" label="入库等级"> </el-table-column>
      <el-table-column prop="createBy" label="检验等级"> </el-table-column>
      <el-table-column prop="createBy" label="检测值"> </el-table-column>
      <el-table-column prop="createBy" label="备注"> </el-table-column>
